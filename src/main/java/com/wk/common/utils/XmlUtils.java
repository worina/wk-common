...
public class XmlUtils {
    ...
    public static JSONObject toJson(byte[] xmlBytes,String charset) throws Exception{
        SAXReader reader = new SAXReader(false);
        InputSource source = new InputSource(new ByteArrayInputStream(xmlBytes));
        source.setEncoding(charset);
        Document doc = reader.read(source);
        JSONObject params = XmlUtils.toJson(doc.getRootElement());
        return params;
    }

    private static JSONObject toJson(Element element){
     ...
     * @throws Exception 
     */
    public static Map<String, String> toALIMap(HttpServletRequest request) throws Exception {
